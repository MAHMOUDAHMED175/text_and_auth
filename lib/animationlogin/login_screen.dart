...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    rootBundle.load('assets/login_animation.riv').then((data) {
      ...
      artboard.addController(controllerSuccess);
      setState(() {
                ...
                child: Column(
                  children: [
                    TextFormField(
                      ...
                      validator: (value){
                        if (value != testEmail) {
                          return "Please enter your email successfully";
                        }
                      },
                      onChanged: (value) {
                        if (value.isNotEmpty &&
                    ...
                    TextFormField(
                      ...
                      validator: (value){
                        if ( value != testPassword ) {
                          return "Please enter your  password successfully";
                        }
                      },
                    ),
                    SizedBox(
